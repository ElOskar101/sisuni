...
namespace SisuniWebApi.Controllers{
    internal static class TokenGenerator {
        public static string GenerateTokenJwt(string identification) {
            ...
            ClaimsIdentity claimsIdentity = new ClaimsIdentity(new[] { new Claim(ClaimTypes.Name, identification) });
